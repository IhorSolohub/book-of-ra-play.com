...
public class BasePage {
    ...
    private final By mainLogoButton = By.xpath("//a[@class='nSsCRgLYSnB']");
    private final By headerOpen = By.xpath("//button[@class='menuBtn JlLAz6U js-menu-btn']");
    private final By closePopupButton = By.xpath("//button[@class='c-universal-popup__close']");
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//a[@class='qTTopwbtA8kq '])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerOpenClick () {
        By checkHeader = By.xpath("(//a[@class='qTTopwbtA8kq '])[2]");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//a[@class='OHr2N '])[" + numButton + "]");
